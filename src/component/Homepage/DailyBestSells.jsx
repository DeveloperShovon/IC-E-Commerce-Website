    ...
    <div>
        <section>
            <div>
                ...
                {/* right part */}
                <div className='absolute bottom-[40px] left-1/2 -translate-x-1/2 w-[90%]  col-span-12 md:static md: translate-x-0 md:col-span-9 flex items-center justify-center'>
                    <ProductSlide/>
                </div>
            </div>
            </div>
