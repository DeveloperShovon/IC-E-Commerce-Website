    ...
    <section>
        <div className=' grid grid-cols-2 gap-4 ' >
            <div className='flex justify-center items-center'>
                <img className='w-md rounded-2xl' src="https://laibkvorwdxzsasecdbs.supabase.co/storage/v1/object/public/Banner/ChooseUs.png" alt="" />
            </div>
            <div>
                <div className='p-4 grid gap-8'>
                    <h1 className='text-xl font-semibold'>Why People Choose us?</h1>
                <div className='grid grid-cols-12 gap-4 border-2 border-gray-100 p-4 rounded-lg'>
                    <div className='col-span-2 text-4xl text-orange-500 justify-center items-center flex'>
